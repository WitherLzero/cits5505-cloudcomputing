...
LAB6_ALB_NAME = f"{STUDENT_NUMBER}-alb-lab6"

# --- Lab 7 Specific Configuration ---
LAB7_KEY_NAME = f"{STUDENT_NUMBER}-key-lab7"
LAB7_INSTANCE_TYPE = "t3.micro"
LAB7_SECURITY_GROUP_NAME = f"{STUDENT_NUMBER}-sg-lab7"